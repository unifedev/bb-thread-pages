 ...
 * source state ride along as headers. A page not written yet is served as a
 * line of host text under a fixed revision, so the poll notices the first
 * save. spec R2.11–R2.13, R2.17, R2.25, R6.19
 */
